...
if (isset($_POST['edit'])) {
    ...
    $q_Update = mysqli_query($conn, "UPDATE project SET nama='$nama', kategori='$kategori', foto='$fileName' WHERE id = '$id'");
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama" value="<?php echo isset($_GET['edit']) ? $row['nama'] : '' ?>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kategori" value="<?php echo isset($_GET['edit']) ? $row['kategori'] : '' ?>" required>
                                    </div>
