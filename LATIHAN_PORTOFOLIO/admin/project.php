                            ...
                            <div class="table table-responsive">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><img width="200" src="../assets/uploads/<?php echo $row['foto']; ?>" alt="foto"></td>
                                            <td><?php echo $row['nama'] ?></td>
                                            <td><?php echo $row['kategori'] ?></td>
                                            <td>
                                                <a class="btn btn-success btn-sm" href="tambah-project.php?edit=<?php echo $row['id'] ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" onclick="return confrim('Yakin ingin delete ?')" href="project.php?delete=<?php echo $row['id'] ?>">Delete</a>
                                            </td>
                                        </tr>
