            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="<?php echo isset($_GET['edit']) ? $rowEdit['customer_phone'] : ''; ?>" number class="form-control"
                            name="customer_phone" required placeholder="Enter Customer Phone">
                    </div>
                    <div class="mb-3">
                        <label for="">Customer Address *</label>
                        <input value="<?php echo isset($_GET['edit']) ? $rowEdit['customer_address'] : ''; ?>" text class="form-control"
