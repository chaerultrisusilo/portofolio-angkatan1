            ...
            <div class="card-body">
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input value="<?php echo isset($_GET['edit']) ? $rowEdit['level_name'] : ''; ?>" type="text" class="form-control"
                            name="level_name" required placeholder="Enter Level Name">
                    </div>
                    <div class="mb-3">
                        <button class="btn btn-primary" type="submit" name="<?php echo isset($_GET['edit']) ? 'edit' : 'save' ?>">Level</button>
                    </div>
                </form>
            </div>
        </div>
